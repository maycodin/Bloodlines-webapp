...
import { Search, Bell, Menu, X, User, Home, BookOpen } from 'lucide-react';
...
const DonorNavbar: React.FC<DonorNavbarProps> = ({ onPageChange, activePage = 'home' }) => {
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex flex-col items-end">
                <span className="text-sm font-semibold text-gray-900">Abdul Matthew</span>
